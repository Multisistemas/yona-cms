...
(29, 'en', 'Admin', 'Admin'),
(30, 'en', 'Multisistemas CMS Admin Panel', 'Multisistemas CMS Admin Panel'),
...
(37, 'ru', 'Admin', 'Админка'),
(38, 'ru', 'Multisistemas CMS Admin Panel', 'Административная панель Multisistemas CMS'),
...
(45, 'uk', 'Admin', 'Адмінка'),
(46, 'uk', 'Multisistemas CMS Admin Panel', 'Адміністративна панель Multisistemas CMS'),
...
CREATE TABLE IF NOT EXISTS `company_user` (
  ...
  `updated_by` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_companys_users_users1_idx` (`user_id` ASC),
  INDEX `fk_companys_users_companys1_idx` (`company_id` ASC),
  CONSTRAINT `fk_companys_users_users1`
    FOREIGN KEY (`user_id`)
    REFERENCES `user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_companys_users_companys1`
...
-- -----------------------------------------------------
-- Table `company_system`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `company_system` ;
...
CREATE TABLE IF NOT EXISTS `company_system` (
  ...
  `updated_by` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_company_system_company1_idx` (`company_id` ASC),
  INDEX `fk_company_system_system1_idx` (`system_id` ASC),
  CONSTRAINT `fk_company_system_company1`
    FOREIGN KEY (`company_id`)
    REFERENCES `company` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_company_system_system1`
...
INSERT INTO `role` (`id`, `name`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES (NULL,'admin', DEFAULT, DEFAULT, NULL, NULL);
INSERT INTO `role` (`id`, `name`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES (NULL,'guest', DEFAULT, DEFAULT, NULL, NULL);
...
INSERT INTO `permission` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES (NULL,'create', 'dashboard', 'permission create', DEFAULT, DEFAULT, NULL, NULL);
INSERT INTO `permission` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES (NULL,'read', 'dashboard', 'permission read', DEFAULT, DEFAULT, NULL, NULL);
INSERT INTO `permission` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES (NULL,'update', 'dashboard', 'permission update', DEFAULT, DEFAULT, NULL, NULL);
INSERT INTO `permission` (`id`, `name`, `module`, `description`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES (NULL,'delete', 'dashboard', 'permission delete', DEFAULT, DEFAULT, NULL, NULL);
...
INSERT INTO `role_permission` (`id`, `role_id`, `permission_id`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES (NULL,1, 1, DEFAULT, DEFAULT, NULL, NULL);
INSERT INTO `role_permission` (`id`, `role_id`, `permission_id`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES (NULL,1, 2, DEFAULT, DEFAULT, NULL, NULL);
INSERT INTO `role_permission` (`id`, `role_id`, `permission_id`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES (NULL,1, 3, DEFAULT, DEFAULT, NULL, NULL);
INSERT INTO `role_permission` (`id`, `role_id`, `permission_id`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES (NULL,1, 4, DEFAULT, DEFAULT, NULL, NULL);
...
INSERT INTO `system` (`id`, `name`, `shortname`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES (NULL,'Enterprise Resource Planning', 'ERP', DEFAULT, DEFAULT, NULL, NULL);
INSERT INTO `system` (`id`, `name`, `shortname`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES (NULL,'Document Management System', 'DMS', DEFAULT, DEFAULT, NULL, NULL);
INSERT INTO `system` (`id`, `name`, `shortname`, `created_at`, `updated_at`, `created_by`, `updated_by`) VALUES (NULL,'Learning Management System', 'LMS', DEFAULT, DEFAULT, NULL, NULL);
